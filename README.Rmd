...
**RaCInG** (**Ra**ndom **C**ell-cell **In**teraction **G**enerator) reconstructs
...
random cell-cell interaction generator
## Installation
...
This R package implementation was developed by [Marcelo Hurtado](https://github.com/mhurtado13) from the [Pancaldi team](https://www.crct-inserm.fr/en/equipe/pancaldi/), led by Vera Pancaldi. Marcelo is currently the primary maintainer of the package.
