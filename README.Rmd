...
This R package implementation was developed by [Marcelo Hurtado](https://github.com/mhurtado13) from the [Pancaldi team](https://www.crct-inserm.fr/en/equipe/pancaldi/). Marcelo is currently the primary maintainer of the package.
